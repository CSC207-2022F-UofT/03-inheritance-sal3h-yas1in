...
public abstract class Bag {
    ...
    public boolean addItem(String item) {
        if (contents.length < this.capacity) {
            String[] newArr = Arrays.copyOf(this.contents, this.contents.length + 1);
     ...
     *
     * @return String that is the last item in the bag
     */
    public String popItem() {
        String output = this.contents[this.contents.length - 1];
